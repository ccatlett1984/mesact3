...
def default(parent):
	...
	parent.sample_7c80_pb.setEnabled(True)
	...
	parent.sample_7i96_pb.setEnabled(True)
...
def sample_5i25_7i76(parent):
	...
	parent.c2_input_0.setText('Digital 0')
	parent.c2_input_invert_0.setChecked(True)
	parent.c2_input_31.setText('Digital 1')
	parent.c2_output_0.setText('Digital Out 0')
	parent.c2_output_invert_0.setChecked(True)
	parent.c2_output_15.setText('Digital Out 1')
...
def sample_7c80(parent):
	parent.board_cb.setCurrentIndex(parent.board_cb.findText('7c80'))
	parent.address_cb.setCurrentIndex(parent.address_cb.findData('/dev/spidev0.0'))
	set_joints(parent, 0, ['X', 'Y', 'Z'], 'stepper')
	parent.c0_input_0.setText('Digital 0')
	parent.c0_input_invert_0.setChecked(True)
	parent.c0_input_1.setText('Digital 1')
	parent.c0_input_debounce_1.setChecked(True)
	parent.c0_input_23.setText('Digital 2')
	parent.c0_output_0.setText('Digital Out 0')
	parent.c0_output_invert_0.setChecked(True)
	parent.c0_output_7.setText('Digital Out 1')
...
def sample_7i76eu(parent):
	...
	parent.c0_input_0.setText('Digital 0')
	parent.c0_input_invert_0.setChecked(True)
	parent.c0_input_31.setText('Digital 1')
	parent.c0_output_0.setText('Digital Out 0')
	parent.c0_output_invert_0.setChecked(True)
	parent.c0_output_15.setText('Digital Out 1')
	parent.c0_home_sequence_0.setText('2')
	parent.c0_home_sequence_1.setText('1')
	parent.c0_home_sequence_2.setText('0')
...
def sample_7i95t(parent):
	...
	parent.c0_output_0.setText('Digital Out 0')
	parent.c0_output_invert_0.setChecked(True)
	parent.c0_output_5.setText('Digital Out 1')
	parent.c0_home_sequence_0.setText('2')
	parent.c0_home_sequence_1.setText('1')
	parent.c0_home_sequence_2.setText('0')

def sample_7i96(parent):
	parent.board_cb.setCurrentIndex(parent.board_cb.findText('7i96'))
	parent.address_cb.setCurrentIndex(parent.address_cb.findData('10.10.10.10'))
	set_joints(parent, 0, ['X', 'Y', 'Z'], 'stepper')
	parent.c0_input_0.setText('Digital 0')
	parent.c0_input_invert_0.setChecked(True)
	parent.c0_input_10.setText('Digital 1')
	parent.c0_output_0.setText('Digital Out 0')
	parent.c0_output_invert_0.setChecked(True)
	parent.c0_output_5.setText('Digital Out 1')
	parent.c0_home_sequence_0.setText('2')
...
def sample_7i96s(parent):
	...
	parent.c0_input_1.setText('Digital 1')
	parent.c0_input_debounce_1.setChecked(True)
	parent.c0_input_10.setText('Digital 2')
	parent.c0_output_0.setText('Digital Out 0')
	parent.c0_output_invert_0.setChecked(True)
	parent.c0_output_5.setText('Digital Out 1')
	parent.c0_home_sequence_0.setText('2')
...
def sample_7i97t(parent):
	...
	parent.c0_input_1.setText('Digital 1')
	parent.c0_input_debounce_1.setChecked(True)
	parent.c0_input_15.setText('Digital 2')
	parent.c0_output_0.setText('Digital Out 0')
	parent.c0_output_invert_0.setChecked(True)
	parent.c0_output_5.setText('Digital Out 1')
	parent.c0_home_sequence_0.setText('2')
...
def set_joints(parent, card, axes, drive_type):
	parent.linear_units_cb.setCurrentIndex(parent.linear_units_cb.findText('Inch'))
